...
export default function AProposPage() {
  return (
    <div className="bg-gradient-to-b from-nur-cream-50 to-white">
      ...
      {/* Mission Section */}
      <section className="py-16 bg-nur-navy-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-nur-navy-900 mb-6">
              Notre Mission
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-semibold text-nur-navy-900 mb-4">Accueil</h3>
              <p className="text-nur-navy-700">
                Notre mosquée est ouverte à tous, musulmans et non-musulmans, dans un esprit de dialogue, de compréhension mutuelle et de respect des différences.
              </p>
            </div>
          </div>
        </div>
